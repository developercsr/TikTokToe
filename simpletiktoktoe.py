...
def choosing():
	try:
		...
		choosing()
def again():
	print("\n\nDo you want to play again please select your option")
	print("\n1.YES\n2.NO")
	try:
		...
		if z==1:
			...
			print("Please select option between 1 or 2 ")
			again()
	except SystemExit:
		exit()
	except :
		print("Please enter your option in the form of numbers and mak esure that it is between 1 or 2")
		again()
def display(i,j):
	if(l[i-1]=='$' or l[i-1]=='@'):
		if(j==1):
